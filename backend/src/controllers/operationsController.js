...
import {
  ...
  getParkingRoute,
} from "../services/parkingAvailabilityService.js";
...
export async function getParkingRouteController(req, res) {
  const data = await getParkingRoute(req.validated.query);
  res.json({
    success: true,
    data,
  });
